<?php
/*
Template Name:カテゴリーページ(記事ページ⑤の遷移先)
*/
get_header(); ?>
...
<div class="container">
    ...
    <!-- <h3 class="category_ttl">カテゴリー：『<?php single_cat_title(); ?>』に関する記事一覧</h3> -->
    <div class="wrap">
      <div class="colum">
    <!-- この記事を書いたライター-->
      <div class="writer author">
            <h3>LIVEフォーチュン ブログ編集部</h3>
            <div class="inner">
              <div class="left">
                <img src="<?php echo get_template_directory_uri(); ?>/img/writer.png" alt="">	
              </div>
              <div class="right">
                <!-- <h4>LIVEフォーチュンブログ編集部</h4> -->
                <p>LIVEフォーチュンブログ編集部は、恋愛・人間関係などの悩みにこたえ、今よりもっと幸せになるためのヒントや情報を発信しています。</p>
              </div>
            </div>
      </div>
      <!-- この記事を書いたライター-->
